          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-3xl shadow-2xl border-4 border-black">
              ...
              <form onSubmit={handleAuthorizeUser} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white font-black py-3 px-6 rounded-2xl border-3 border-black shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 flex items-center gap-2 justify-center"
                >
